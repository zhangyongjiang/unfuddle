...
public class DesktopBus {
	 ...
	 * 
	 * @param handler
	 *            the add file model handler
	 * @return a registration that can be used to remove the handler
	 */
	public HandlerRegistration addAddFileModelHandler(
	        AddFileModelHandler handler) {
	 ...
	 * @return a registration that can be used to remove the handler
	 */
	public HandlerRegistration addOpenFileModelHandler(
	        OpenFileModelHandler handler) {
		return eventBus.addHandler(OpenFileModelEvent.TYPE, handler);
	}

	public HandlerRegistration addPropertyHandler(PropertyHandler handler) {
		return eventBus.addHandler(PropertyEvent.TYPE, handler);
	}
	 ...
	 * 
	 * @param handler
	 *            the file remove handler
	 * @return a registration that can be used to remove the handler
	 */
	public HandlerRegistration addRemoveFileModelHandler(
	        RemoveFileModelHandler handler) {
	 ...
	 * 
	 * @param handler
	 *            the file select handler
	 * @return a registration that can be used to remove the handler
	 */
	public HandlerRegistration addSelectFileModelHandler(
	        SelectFileModelHandler handler) {
	 ...
	 * 
	 * @param handler
	 *            the file update handler
	 * @return a registration that can be used to remove the handler
	 */
	public HandlerRegistration addUpdateFileModelHandler(
	        UpdateFileModelHandler handler) {
		return eventBus.addHandler(UpdateFileModelEvent.TYPE, handler);
	}

	/**
	 * Adds a handler that is invoked when the user has updated their profile,
	 * or cancelled the profile update operation.
	 * 
	 * @param handler
	 *            the profile update handler
	 * @return a registration that can be used to remove the handler
	 */
	public HandlerRegistration addUpdateProfileHandler(
	...
	/**
	 * Fires an event indicating the user has selected a file without opening
	 * it.
	 * 
	 * @param event
	 ...
	 * 
	 * @param provider
	 *            the profile service provider
	 */
	public void registerProfileService(ProfileServiceProvider provider) {
		serviceBus.registerServiceProvider(ProfileServiceRequest.class,
		        provider);
	}
