...
public class BuiltInPlugins {
    ...
    public static Plugin getYahooQuotePlugin() {
        Plugin plugin = new Plugin();
        plugin.setName("Yahoo Finance");
        plugin.setCountry("US");
        ...
        plugin.setUrl(url);
        plugin.setSampleUrl(url.replaceAll("__SYM__", "IBM"));
        String postAction = "removeAllExceptTagClass('div', 'yfi_quote_summary');";
//        String postAction = "scrollTo(getElementByTagWithClass('div', 'yfi_quote_summary'));";
        plugin.setPostAction(postAction);
        return plugin;
    }
