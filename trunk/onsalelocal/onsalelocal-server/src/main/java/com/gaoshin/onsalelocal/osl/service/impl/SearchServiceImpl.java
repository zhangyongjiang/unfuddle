...
public class SearchServiceImpl implements SearchService {
    ...
    public OfferSearchResponse search(final OfferSearchRequest req) throws Exception {
        ...
        if(req.getSource()!=null && !com.nextshopper.api.DataSource.Shoplocal.getValue().equals(req.getSource())) {
        	hasSlocalOffer = true;
        }
        ...
        for(SolrDocument doc : result) {
            ...
            if(com.nextshopper.api.DataSource.Shoplocal.getValue().equalsIgnoreCase(offer.getSource()))
            	hasSlocalOffer = true;
	        try {
