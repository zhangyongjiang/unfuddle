...
import com.nextshopper.osl.entity.NotificationStatus;
import com.nextshopper.osl.entity.NotificationType;
import com.nextshopper.osl.entity.OfferComment;
import com.nextshopper.osl.entity.PushStatus;
...
public class PushNotificationServiceImpl implements PushNotificationService {
	...
	@Value("${apn_certification-file:/nextshopper-dev-20140201-for-srv.p12}")
	private String certFile = "/nextshopper-dev-20140201-for-srv.p12";
	...
	public void init() {
		apnService = APNS.newService()
				.withCert(this.getClass().getResourceAsStream(certFile), "r3dmine!")
    ...
    public void notifyShareOffer(String userId, Offer offer) {
		...
		User user = oslDao.getEntity(User.class, userId);
		Company store = oslDao.getEntity(Company.class, offer.getMerchantId());
