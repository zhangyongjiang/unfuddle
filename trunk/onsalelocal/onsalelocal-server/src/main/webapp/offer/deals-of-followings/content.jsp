...
<%
	...
	String url = "/ws/v2/offer-of-followings?format=object&" + (param == null ? "" : param);;
	request.getRequestDispatcher(url).include(request, response);
%>
<osl:ws path="<%=url %>"/>
<h3>Offers Liked by Followings of User ${it.userDetails.firstName } ${it.userDetails.lastName } </h3>
