...
public class JerseyBaseResource {
    ...
    public static final boolean encrypeUserId = false;
	...
	protected void setUserIdCookie(String userId) {
		if(encrypeUserId) {
			...
			setCookie(UserCookieName, userId);
		}
	}
    ...
    protected Long getLongValue(String str, long def) {
    	Long l = getLongValue(str);
    	return l == null ? def : l;
    }
    
    protected void assertNotNull(Object obj, String msg) {
    	if(obj == null)
    		throw new BusinessException(ServiceError.InvalidInput, msg);
    }
