...
public interface GenericDao {
    ...
    <T> List<T> queryBySql(Class<T> cls, String sql, Object... objs);
	...
	int update(String sql, String[] names, Object[] values);
	<T> T queryUniqueBySql(Class<T> cls, Object[] params, String sql);
