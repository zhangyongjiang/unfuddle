...
<%@ taglib tagdir="/WEB-INF/tags/raved" prefix="r" %>
<%
...
<c:if test="${not empty it.deals.deal}">
	...
	<c:forEach var="deal" items="${it.deals.deal}">
        <tr>
            <td style="padding:3px;border:solid 1px #ccc;"><img src='${deal.mediumImageUrl}'/></td>
            <td style="padding:3px;border:solid 1px #ccc;"><a href='../deal-details/index.jsp.oo?dealId=${deal.id }'>${deal.title}</a></td>
            <td style="padding:3px;border:solid 1px #ccc;">${deal.merchant.name}
