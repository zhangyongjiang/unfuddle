...
if (typeof Device === 'undefined') {
	Device = {
		...
		getPhoneCookieValue: function() {
			return "____";
		},
		pickupPhotoFromGallery: function(width, height, target) {
			if(target.indexOf("album")!=-1) {
				window.location = '<c:url value="/m/user/alblum/upload/index.jsp.oo"/>';
			}
			else {
				window.location = '<c:url value="/m/user/icon/upload/index.jsp.oo"/>';
			}
		}
	};
}
