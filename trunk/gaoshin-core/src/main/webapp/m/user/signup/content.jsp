...
<div data-role="fieldcontain" id="pwdcontainer1">
    <label for="password">Password:</label>
    <input type="text" name="password" id="password" value="" data-theme="d" />
</div>	

<div data-role="fieldcontain" id="pwdcontainer2">
...
function signup() {
    ...
    if(phone == null) {
		...
		if(password2 == null || password2.trim().length == 0) {
			alert("All filelds are required. Please check password2 field.");
			return false;
		}
		if(password != password2) {
			alert("Two passwords you entered don't match.");
			return false;
		}
    }
