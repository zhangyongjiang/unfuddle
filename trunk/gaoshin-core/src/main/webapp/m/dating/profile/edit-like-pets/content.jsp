...
<h3>Like pets?</h3>
    ...
    <fieldset data-role="controlgroup" >
    	<% 	for (DimensionPets like : DimensionPets.class.getEnumConstants()) {%>
         	<input type="radio" data-theme='c' name="radio-like" id="<%=like.name() %>" value="<%=like.name() %>" <%if(like.equals(profile.getPets())){ %>checked="checked"<%}%> />
...
function change() {
	...
	$.ajax({
		url : serverBase + "/dating/profile/edit-like-pets",
		type : "POST",
		data : json,
