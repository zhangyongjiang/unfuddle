...
<div data-role="collapsible" data-theme="d" data-collapsed="false" style="padding-right:12px;">
	<h3>Album</h3>
	...
	<div style="float:right;" data-inline="true">
		<a href='#' data-theme='b' data-role="button" onclick="Device.pickupPhotoFromGallery(0, 0, '<o:url value="/user/album"/>', null, 'iconUploadSuccessCallback', 'iconUploadErrorCallback')">Upload</a>
	</div>
	</c:if>
</div>
