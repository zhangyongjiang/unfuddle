...
public void printNode(AwsBrowseNode node, JspWriter out) throws Exception {
    ...
    for(List<AwsBrowseNode> path : all) {
        ...
        for(AwsBrowseNode n : path) {
    	    out.write("<a href='/xo/aws/node/" + n.getId() + "'>" + n.getName() + "</a> ");
    	    out.write("<a href='javascript:void(0)' onclick=\"parent.gaoshin.addChild('" + n.getName() + "}')\"><img src='/m/images/right.png'/></a><br/><br/>");
        }
        out.write("</td>");
    }
    out.write("</tr>");
