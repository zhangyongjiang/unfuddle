...
public class UserServiceImpl extends ServiceBaseImpl implements UserService {
    ...
    public User facebookLogin(Account account) throws Exception {
		...
		Map<String, String> fbuser = facebookMe.me(token);
		...
		if(userId != null) {
			...
			where.put("type", AccountType.Facebook);
	...
	private void addOrReplaceFbUserForExistingUser(Map<String, String> fbuser, String token, User dbuser) {
		Map<String, Object> where = new HashMap<String, Object>();
