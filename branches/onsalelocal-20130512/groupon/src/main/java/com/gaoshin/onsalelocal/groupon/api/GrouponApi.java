 ...
 * http://api.groupon.com/v2/deals?client_id=3ea270b8be4d62fc96824dee239ee84958a0bdf3&division_id=san-francisco
 ...
 */
    ...
    public static void main(String[] args) throws Exception {
        ...
        for(Division div : resp.getDivisions().getDivision()) {
