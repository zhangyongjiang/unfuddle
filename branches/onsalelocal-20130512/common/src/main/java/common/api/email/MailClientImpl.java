...
public class MailClientImpl implements MailClient {
    ...
    @Value ("${mail.inboxUserName}") private String inboxUserName = "zhangyongjiang@gmail.com";
    @Value ("${mail.inboxPassword}") private String inboxPassword = "GAO0xing";
    @Value ("${mail.outboxUserName}") private String outboxUserName = "zhangyongjiang@gmail.com";
    @Value ("${mail.outboxPassword}") private String outboxPassword = "GAO0xing";
