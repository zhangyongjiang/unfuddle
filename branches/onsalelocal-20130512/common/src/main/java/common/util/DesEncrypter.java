...
public class DesEncrypter {
    ...
    public String encrypt(String str) {
        try {
            ...
            String string = new String(b64.encode(enc));
            if(string.endsWith("==")) {
    ...
    public String decrypt(String string) {
        try {
            ...
            byte[] dec = b64.decode(string.getBytes());
    ...
    public static String selfencrypt(String... data) {
        ...
        return new DesEncrypter(MD5.md5(d2).substring(4, 4)).encrypt64(data[0]) + d2;
    }
    ...
    public static List<String> selfdecrypt(String encrypted) {
        ...
        String d1 = new DesEncrypter(MD5.md5(d2).substring(4, 4)).decrypt64(encrypted.substring(0, pos));
    ...
    public static void main(String[] args) {
        DesEncrypter encrypter = new DesEncrypter("abc");
