...
import com.gaoshin.onsalelocal.api.CompanyList;
...
public class CompanyResource extends JerseyBaseResource {
    ...
    @GET
    @Path("/list")
    public CompanyList list(@QueryParam("offset") @DefaultValue("0") int offset, @QueryParam("size") @DefaultValue("100") int size) throws Exception{
