...
public class StoreDaoImpl extends GenericDaoImpl implements StoreDao {
	...
	@Override
    public void incOfferCount(String merchantId) {
		String sql = "update Store set offers=offers+1 where id=:id";
		getNamedParameterJdbcTemplate().update(sql, Collections.singletonMap("id", merchantId));
    }
