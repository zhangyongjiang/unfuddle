...
public class GroupItemsView extends ScrollView {
    ...
    private void deleteItem(final GroupItem groupItem) {
        ...
        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                groupItemDeleted(groupItem.getId());
            }
        })
    ...
    public void groupItemDeleted(Integer groupItemId) {
        int i;
        for(i=0; i<symViewList.size(); i++) {
            if(symViewList.get(i).getGroupItem().getId() == groupItemId) {
        ...
        if(i<=current) {
            ...
            if(current>=0 && symViewList.size() > 0) {
