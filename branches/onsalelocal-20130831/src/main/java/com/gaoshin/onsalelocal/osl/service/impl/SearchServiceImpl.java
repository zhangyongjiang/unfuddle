...
public class SearchServiceImpl implements SearchService {
    ...
    @Autowired @Qualifier("searchServer")
    ...
    public OfferSearchResponse search(final OfferSearchRequest req) throws Exception {
        ...
        QueryResponse resp = searchServer.query(query);
        ...
        for(SolrDocument doc : result) {
            ...
            offer.setCategory((String)doc.getFieldValue("category"));
            offer.setSubcategory((String)doc.getFieldValue("subcategory"));
            offer.setTags((String)doc.getFieldValue("tags"));
