...
if(lat!=null && lng!=null) {
    ...
    mapurl = "/index.jsp.oo?lat=" + lat + "&lng=" + lng; 
} else if (me!= null && me.getCurrentLocation()!=null) {
    lat = me.getCurrentLocation().getLatitude() + "";
    lng = me.getCurrentLocation().getLongitude() + "";
    location = location + "&lat=" + lat + "&lng=" + lng;
    mapurl = "/index.jsp.oo?lat=" + lat + "&lng=" + lng; 
}
%>
...
<c:forEach var="user" items="${it.list }">
	<div style='width:100%;clear:both;padding:6px 0px 6px 0px;border-bottom:solid 1px #aaa;'>
