...
<div style="clear:both;">
	...
	<li>
		<h4><a href="#" onclick="window.location='<c:url value="/m/feedback/list/index.jsp.oo"/>'">Feedback</a></h4>
	</li>
	<li>
		<h4><a href="#" onclick="window.location='<c:url value="/m/poem/list/index.jsp.oo"/>'">Poem</a></h4>
	</li>
	<li>
	...
	<li>
		<h4><a href="#" onclick="javascript:Device.exit()">Exit</a></h4>
	</li>
