...
public class ServiceExceptionMapper implements ExceptionMapper<BusinessException> {
    ...
    public Response toResponse(BusinessException exception) {
        if (requestInvoker.get().getParameter("stacktrace") != null) {
        ...
        try {
            ...
            if (html) {
                ...
                return Response.status(exception.getErrorCode().getErrorCode()).type(MediaType.TEXT_XML_TYPE).entity(xmlStr).build();
            }
        } catch (Exception e) {
