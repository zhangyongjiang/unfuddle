 ...
 *         &lt;element ref="{http://webservices.amazon.com/AWSECommerceService/2008-08-19}List" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Lists {
    ...
    protected java.util.List<com.gaoshin.amazon.jax.List> list;
     ...
     * {@link com.gaoshin.amazon.jax.List }
     * 
     * 
     */
    public java.util.List<com.gaoshin.amazon.jax.List> getList() {
        if (list == null) {
            list = new ArrayList<com.gaoshin.amazon.jax.List>();
        }
        return this.list;
    }
